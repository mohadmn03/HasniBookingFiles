...
const List = () => {
  ...
  const [destiniation, setDestiniation] = useState(location.state.destiniation);
        ...
        <div className="listWrapper">
          <div className="listSearch">
            ...
            <div className="lsItem">
              <label htmlFor="">Destiniation</label>
              <input placeholder={destiniation} type="text" />
            </div>
            <div className="lsItem">
              <label htmlFor="">Check-in Date</label>
              <span className='exc' onClick={()=>{setOpenDate(!openDate)}}>
